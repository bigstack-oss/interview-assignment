...
exports.utilSetCollapsed = exports.utilGetBreadcrumbItemForTitle = exports.utilCheckUpdateVerticalSpace = exports.blockClass = void 0;
...
var utilGetBreadcrumbItemForTitle = function utilGetBreadcrumbItemForTitle(blockClass, collapseTitle, title) {
  ...
  if (title) {
    if (title.text !== undefined) {
      ...
      breadcrumbTitle = {
        label: /*#__PURE__*/_react.default.createElement("span", null, title.loading ? /*#__PURE__*/_react.default.createElement(_react2.SkeletonText, null) : title.text),
        title: title.text
      };
    ...
    if (breadcrumbTitle) {
      ...
      breadcrumbTitle.className = (0, _classnames.default)(["".concat(blockClass, "__breadcrumb-title"), (0, _defineProperty2.default)({}, "".concat(blockClass, "__breadcrumb-title--pre-collapsed"), collapseTitle)]);
    }
