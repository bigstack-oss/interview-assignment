...
import { ComposedModal, ModalHeader, ModalFooter, ModalBody, TextInput, PasswordInput, InlineLoading, Form, Button } from '@carbon/react';
...
export var APIKeyModal = /*#__PURE__*/forwardRef(function (_ref, ref) {
  ...
  return /*#__PURE__*/React.createElement(ComposedModal, _extends({}, rest, _objectSpread({
  ...
  }, /*#__PURE__*/React.createElement(ErrorFilled, {
    size: 16
    ...
    className: "".concat(blockClass, "__messaging")
  }, /*#__PURE__*/React.createElement(InformationFilled, {
    size: 16
