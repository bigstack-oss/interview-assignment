...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-nt59cy8px2j">Show
  modal</button>

<div data-modal id="modal-nt59cy8px2j" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-nt59cy8px2j-label" aria-describedby="modal-nt59cy8px2j-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--xs">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-nt59cy8px2j-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-nt59cy8px2j-heading">Passive modal title as the message. Should be direct and 3 lines or less.</p>
