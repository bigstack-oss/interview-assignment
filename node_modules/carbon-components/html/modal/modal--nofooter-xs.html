...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-ej6nrlyh1i5">Show
  modal</button>

<div data-modal id="modal-ej6nrlyh1i5" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-ej6nrlyh1i5-label" aria-describedby="modal-ej6nrlyh1i5-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--xs">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-ej6nrlyh1i5-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-ej6nrlyh1i5-heading">Modal heading</p>
