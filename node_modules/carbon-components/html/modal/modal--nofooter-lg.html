...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-ybjll4ahxs">Show
  modal</button>

<div data-modal id="modal-ybjll4ahxs" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-ybjll4ahxs-label" aria-describedby="modal-ybjll4ahxs-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--lg">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-ybjll4ahxs-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-ybjll4ahxs-heading">Modal heading</p>
