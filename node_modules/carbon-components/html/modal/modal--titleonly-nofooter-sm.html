...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-jnavbic9sw">Show
  modal</button>

<div data-modal id="modal-jnavbic9sw" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-jnavbic9sw-label" aria-describedby="modal-jnavbic9sw-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--sm">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-jnavbic9sw-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-jnavbic9sw-heading">Passive modal title as the message. Should be direct and 3 lines or less.</p>
