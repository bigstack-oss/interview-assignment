...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-urjd5g03afc">Show
  modal</button>

<div data-modal id="modal-urjd5g03afc" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-urjd5g03afc-label" aria-describedby="modal-urjd5g03afc-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-urjd5g03afc-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-urjd5g03afc-heading">Modal heading</p>
    ...
    <div class="bx--modal-content bx--modal-content--with-form" >
      <div class="bx--form-item">
        <label for="text-input-urjd5g03afc" class="bx--label">Text Input label</label>
        <input id="text-input-urjd5g03afc" type="text" class="bx--text-input" placeholder="Optional placeholder text"
