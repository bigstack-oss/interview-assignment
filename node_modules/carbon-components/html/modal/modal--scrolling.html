...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-okaoetvr23c">Show
  modal</button>

<div data-modal id="modal-okaoetvr23c" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-okaoetvr23c-label" aria-describedby="modal-okaoetvr23c-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-okaoetvr23c-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-okaoetvr23c-heading">Modal heading</p>
