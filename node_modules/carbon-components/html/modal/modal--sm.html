...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-t8i5pvjkxy">Show
  modal</button>

<div data-modal id="modal-t8i5pvjkxy" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-t8i5pvjkxy-label" aria-describedby="modal-t8i5pvjkxy-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--sm">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-t8i5pvjkxy-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-t8i5pvjkxy-heading">Modal heading</p>
