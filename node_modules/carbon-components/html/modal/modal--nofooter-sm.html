...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-cudht3ccvr">Show
  modal</button>

<div data-modal id="modal-cudht3ccvr" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-cudht3ccvr-label" aria-describedby="modal-cudht3ccvr-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--sm">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-cudht3ccvr-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-cudht3ccvr-heading">Modal heading</p>
