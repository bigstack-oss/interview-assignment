...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-m1j5ywafaoa">Show
  modal</button>

<div data-modal id="modal-m1j5ywafaoa" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-m1j5ywafaoa-label" aria-describedby="modal-m1j5ywafaoa-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--xs">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-m1j5ywafaoa-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-m1j5ywafaoa-heading">Passive modal title as the message. Should be direct and 3 lines or less.</p>
