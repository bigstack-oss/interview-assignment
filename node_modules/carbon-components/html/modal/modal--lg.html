...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-zqeydorkof">Show
  modal</button>

<div data-modal id="modal-zqeydorkof" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-zqeydorkof-label" aria-describedby="modal-zqeydorkof-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--lg">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-zqeydorkof-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-zqeydorkof-heading">Modal heading</p>
