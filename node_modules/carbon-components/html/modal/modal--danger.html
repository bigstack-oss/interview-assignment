...
<button class="bx--btn bx--btn--danger" type="button" data-modal-target="#modal-h0kbvi1wvyu">Show
  modal</button>

<div data-modal id="modal-h0kbvi1wvyu" class="bx--modal bx--modal--danger" role="dialog"
  aria-modal="true" aria-labelledby="modal-h0kbvi1wvyu-label" aria-describedby="modal-h0kbvi1wvyu-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-h0kbvi1wvyu-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-h0kbvi1wvyu-heading">Modal heading</p>
