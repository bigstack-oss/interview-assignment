...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-rcf0o8tigqg">Show
  modal</button>

<div data-modal id="modal-rcf0o8tigqg" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-rcf0o8tigqg-label" aria-describedby="modal-rcf0o8tigqg-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--xs">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-rcf0o8tigqg-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-rcf0o8tigqg-heading">Modal heading</p>
