...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-8a0qj0yu1ub">Show
  modal</button>

<div data-modal id="modal-8a0qj0yu1ub" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-8a0qj0yu1ub-label" aria-describedby="modal-8a0qj0yu1ub-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-8a0qj0yu1ub-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-8a0qj0yu1ub-heading">Modal heading</p>
