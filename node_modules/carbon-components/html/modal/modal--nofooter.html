...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-jb9lu2w9krb">Show
  modal</button>

<div data-modal id="modal-jb9lu2w9krb" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-jb9lu2w9krb-label" aria-describedby="modal-jb9lu2w9krb-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-jb9lu2w9krb-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-jb9lu2w9krb-heading">Modal heading</p>
